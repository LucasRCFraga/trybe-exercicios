...
const resultadoGeral = estudantes.map((element) => {
  // const notaGeral = element.materias;
  const notaAluno = element.materias.reduce((acc, notaDoAluno) => acc.nota > notaDoAluno.nota ? acc : notaDoAluno);

  return {
      name: element.nome,
      materia: notaAluno.name,
  };
});
